...
function Contact() {
  return (
    ...
    <img
    className="mx-auto mt-3 md:mt-6 lg:mt-20 w-max h-36 md:h-44"
    src={"../../public/36.png"}
    alt="let Collaborate"
    />
    </div>
    ...
    default_velocity={4}
    className="font-display !text-gray-800 text-center text-4xl w-full  tracking-[-0.02em] text-black drop-shadow-sm text0 md:text-7xl md:leading-[5rem]"
    />

    </div>

    <footer className="lg:px-20 p-6 px-10 mt-8 flex justify-between">
    <div className="!font-medium">
    <span className="text-slate-500">© 2024</span> Idongesit Ntuk
    </div>

    <div>
    <div className="flex flex-row *:size-7 *:text-gray-600 items-center md:gap-x-4 lg:gap-x-6 xl:gap-x-7 ">
