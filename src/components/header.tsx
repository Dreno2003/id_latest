  ...
  return (
    <header className="bg-white">
      ...
      >
        ...
        >
          <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto border-l border-slate-600 bg-black z-50  text-gray-100 px-6 py-6 sm:max-w-[30rem] sm:ring-1 sm:ring-gray-900/10">
